...
% For including photo of CV_Author
\usepackage{graphicx}
...
\newcommand{\colorrule}[3]{{\color{#1}\rule{#3}{#2}}}
...
%\usepackage{lmodern}
%\usepackage[light=true,scale=.95,type1]{Chivo} 
%\usepackage{cmbright} 
% math fonts
\usepackage[baskervillef,vvarbb]{newtxmath}
...
\renewcommand{\ttfamily}{inconsolata}
...
\newcommand{\UseHeaderFooterFont}{\UseHeadingFont\footnotesize}
...
\newcommand{\UseSectionFont}{\fontfamily{\sffamily}\selectfont \bfseries \color{CVColor}}
\newcommand{\UseSubSectionFont}{\fontfamily{\sffamily}\selectfont \bfseries \color{CVColor}}
...
%\fancyfoot[L]{}
%\fancyfoot[C]{\UseHeaderFooterFont {Page}~{\thepage}~of~\pageref{LastPage}}
%\fancyfoot[R]{}
%\renewcommand{\footrulewidth}{0.4pt}
\ifnum\TypesetInDraftMode=0
\newcommand{\HeaderText}{}
\newcommand{\FooterText}{\UseHeaderFooterFont\CVTitle\hfill%
{Page}~{\thepage}~of~\pageref{LastPage}}
\else
\newcommand{\HeaderText}{\hfill \CVTitle}
...
\newcommand{\addname}[1]{%
\par\vspace*{-0.3cm} %
\par{\huge\fontfamily{\sffamily}\selectfont\textbf{\hspace*{0.2cm}#1}}%
\par}
...
\par\vspace*{-0.1cm} %
\par\begin{figure}[h]%
\par\hspace*{0.80\textwidth} \includegraphics[width=0.2\textwidth]{#1}%
\par\end{figure}%
\par}
